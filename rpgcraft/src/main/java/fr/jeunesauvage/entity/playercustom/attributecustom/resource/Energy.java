...
public class Energy implements Resource {
	...
	public Energy(@NonNull Player p, double v, double vMax) {
		this.player = p;
		this.type = ResourceType.ENERGY;
		this.value = v;
		this.valueMax = vMax;
	}
	...
	*/
	...
	public void setValue(double v) {
		...
		Data.setDouble(player.getPersistentDataContainer(), ResourceType.ENERGY.getKey(), value);
	}
