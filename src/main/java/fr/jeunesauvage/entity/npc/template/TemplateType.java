...
public enum TemplateType {
	...
	// dwarfiron
	DWARFIRON(                     "dwarfiron",                     "DwarfIron",                     EntityType.PLAYER,      "dwarfiron_brownbeard",   RaceType.DWARFIRON,       FormType.DWARFIRON,       null,                                  Set.of("alliance"),  180, 10,       0.5,          2f,        10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	DWARFIRON_VENDOR_FOOD(         "dwarfiron_vender_food",         "Vendor Food DwarfIron",         EntityType.PLAYER,      "dwarfiron_redheadbeard", RaceType.DWARFIRON,       FormType.DWARFIRON,       null,                                  Set.of("alliance"),  180, 10,       0.5,          2f,        10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	DWARFIRON_BLACKSMITH(          "dwarfiron_blacksmith",          "BlackSmith DwarfIron",          EntityType.PLAYER,      "dwarfiron_blackbeard",   RaceType.DWARFIRON,       FormType.DWARFIRON,       null,                                  Set.of("alliance"),  180, 10,       0.5,          2f,        10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	DWARFIRON_GUARD(               "dwarfiron_guard",               "Guard DwarfIron",               EntityType.PLAYER,      "dwarfiron_guard",        RaceType.DWARFIRON_GUARD, FormType.DWARFIRON_GUARD, null,                                  Set.of("alliance"),  180, 10,       0.5,          2f,        10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	DWARFIRON_KING(                "dwarfiron_king",                "King DwarfIron",                EntityType.PLAYER,      "dwarfiron_king",         RaceType.DWARFIRON,       FormType.DWARFIRON,       null,                                  Set.of("alliance"),  300, 30,       2,            1.5f,      10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	// murloc
	...
	// desert
	TAUREN_DESERT(                 "tauren_desert",                 "Desert Tauren",                 EntityType.PLAYER,      "tauren_desert",          RaceType.TAUREN,          FormType.TAUREN_EVIL,     null,                                  Set.of("desert"),    180, 10,       0.5,          1.5f,      10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	SCORPION(                      "scorpion",                      "Spider 7",                      EntityType.SPIDER,      null,                     RaceType.SCORPION,        FormType.SCORPION,        null,                                  Set.of("desert"),    180, 12,       0.5,          1.5f,      10f,      TraitSentinel.SPEED_DEFAULT, TraitSentinel.SPEEDCOMBAT_DEFAULT, false),
	// elemental
