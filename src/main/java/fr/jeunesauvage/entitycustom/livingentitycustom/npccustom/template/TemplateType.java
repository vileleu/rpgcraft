...
public enum TemplateType {
	...
	GOLEM_MAGMA(                   "golem_magma",                   "Sheared Admin",                 EntityType.IRON_GOLEM,        RaceType.ELEMENTAL,            FormType.GOLEM_MAGMA,             ClassType.BEGGAR,         Map.of(StatSecondary.PHYSICAL_ARMOR, 5),      Set.of(TeamType.ELEMENTAL, TeamType.DEMON), 180,             30,           1.5,                2f,               FightTrait.SPELLRATE_DEFAULT, FightTrait.SPEED_DEFAULT, 1.2f,                           false),
	ELEMENTAL_FIRE(                "elemental_fire",                "Blaze",                         EntityType.BLAZE,             RaceType.ELEMENTAL,            FormType.ELEMENTAL_FIRE,          ClassType.BEGGAR,         null,                                      Set.of(TeamType.ELEMENTAL),                 180,               5,             0.2,                1.5f,             15f,                          1f,                       1.1f,                           false),
	ELEMENTAL_WIND(                "elemental_wind",                "Breeze",                        EntityType.BREEZE,            RaceType.ELEMENTAL,            FormType.ELEMENTAL_WIND,          ClassType.BEGGAR,         Map.of(StatSecondary.DODGE, 4),               Set.of(TeamType.ELEMENTAL),                 180,             5,            0.2,                1.5f,             15f,                          1f,                       1.1f,                           false),
	// spider
	...
	// forest
	LEAPER(                        "leaper",                        "Ravager 2",                     EntityType.RAVAGER,           RaceType.ELEMENTAL,            FormType.LEAPER,                  ClassType.BEGGAR,         null,                                      Set.of(TeamType.FOREST),                    180,               30,            1,                  2f,               20f,                         FightTrait.SPEED_DEFAULT, 1.5f,                           false),
	WHISPERER(                     "whisperer",                     "Whisperer",                     EntityType.EVOKER,            RaceType.ELEMENTAL,            FormType.WHISPERER,               ClassType.BEGGAR,         null,                                      Set.of(TeamType.FOREST),                    180,               20,            0,                  0,                5f,                          0.5f,                     0.8f,                           false),
	YELLER(                        "yeller",                        "WaveWhisperer",                 EntityType.EVOKER,            RaceType.ELEMENTAL,            FormType.YELLER,                  ClassType.BEGGAR,         null,                                      Set.of(TeamType.FOREST),                    300,               30,            2,                  1,                5f,                          0.5f,                     0.8f,                           true),
	// demon
	DEMON(                         "demon",                         "Demon",                         EntityType.WITHER_SKELETON,   RaceType.DEMON,                FormType.DEMON,                   ClassType.WARRIOR,        null,                                      Set.of(TeamType.DEMON),                     180,               10,            2,                  1.5f,             5f,                          FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	// pet
