...
public enum TemplateType {
	...
	TAUREN_SHAMAN_BLUE(            "tauren_shaman_blue",            "Shaman Tauren Blue",            EntityType.PLAYER,            RaceType.TAUREN,               FormType.TAUREN,                  ClassType.BEGGAR,         null,                                      Set.of(TeamType.HORDE),                     180,               10,            0.5,                2f,               FightTrait.SPELLRATE_DEFAULT, FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	TAUREN_SHAMAN_RED(             "tauren_shaman_red",             "Shaman Tauren Red",             EntityType.PLAYER,            RaceType.TAUREN,               FormType.TAUREN,                  ClassType.BEGGAR,         null,                                      Set.of(TeamType.HORDE),                     180,               10,            0.5,                2f,               FightTrait.SPELLRATE_DEFAULT, FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	...
	// desert
	HUMAN_ROGUE(                   "human_rogue",                   "Rogue Human",                   EntityType.PLAYER,            RaceType.HUMAN,                FormType.HUMAN_ROGUE,             ClassType.ROGUE,          null,                                      Set.of(TeamType.DESERT),                    180,               10,            0.5,                2f,               15f,                          FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	...
	NECROMANCER_NOFACE(            "necromancer_noface",            "Faceless Necromancer",          EntityType.PLAYER,            RaceType.NECROMANCER,          FormType.NECROMANCER_NOFACE,      ClassType.BEGGAR,         Map.of(StatSecondary.PHYSICAL_ARMOR, 100),    Set.of(TeamType.NECRO),                     180,             20,           1,                 1.5f,             FightTrait.SPELLRATE_DEFAULT, FightTrait.SPEED_DEFAULT, 1.1f,                           false),
	NECROMANCER_BONE(              "necromancer_bone",              "Bone Necromancer",              EntityType.PLAYER,            RaceType.NECROMANCER,          FormType.NECROMANCER_BONE,        ClassType.BEGGAR,         Map.of(StatSecondary.PHYSICAL_ARMOR, 100),    Set.of(TeamType.NECRO),                     180,             20,           1,                 2f,               5f,                           FightTrait.SPEED_DEFAULT, 1.1f,                           false),
	NECROMANCER_BONEGREY(          "necromancer_bonegrey",          "Bone Grey Necromancer",         EntityType.PLAYER,            RaceType.NECROMANCER,          FormType.NECROMANCER_BONEGREY,    ClassType.BEGGAR,         Map.of(StatSecondary.PHYSICAL_ARMOR, 100),    Set.of(TeamType.NECRO),                     180,             20,           1,                 2f,               15f,                          FightTrait.SPEED_DEFAULT, 1.1f,                           false),
