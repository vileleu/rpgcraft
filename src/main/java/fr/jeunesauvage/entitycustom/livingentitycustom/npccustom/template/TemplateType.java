...
public enum TemplateType {
	...
	// tauren black                  
	TAUREN_BLACK(                  "tauren_black",                  "Black Tauren",                  EntityType.PLAYER,            RaceType.TAUREN,          FormType.TAUREN_BLACK,            ClassType.WARRIOR,        null,                                  Set.of(TeamType.BLACK),                    180,               10,            0.5,          	  1.5f,             20f,                          FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	PALPOUTINE(                    "palpoutine",                    "Palpoutine",                    EntityType.PLAYER,            RaceType.HUMAN,           FormType.HUMAN_PALPOUTINE,        ClassType.PRIEST,         null,                                  Set.of(TeamType.BLACK),                    300,               20,            1.5,          	  1f,               10f,                          FightTrait.SPEED_DEFAULT, 1.3f,                           true),
	// desert                  
	...
	SCORPION(                      "scorpion",                      "Spider 7",                      EntityType.SPIDER,            RaceType.SCORPION,        FormType.SCORPION,                ClassType.BEGGAR,         null,                                  Set.of(TeamType.DESERT),                   180,               12,            0.5,                1.5f,             FightTrait.SPELLRATE_DEFAULT, FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	// elemental                  
	GOLEM_REDSTONE(                "golem_redstone",                "Redstone Golem",                EntityType.IRON_GOLEM,        RaceType.ELEMENTAL,       FormType.GOLEM_REDSTONE,          ClassType.BEGGAR,         Map.of(StatSecondary.PHYSICAL_ARMOR, 10), Set.of(TeamType.ELEMENTAL),                300,             50,           2,                  2f,               15f,                          FightTrait.SPEED_DEFAULT, 1.2f,                           false),
	...
	SPIDER_NORMAL(                 "spider_normal",                 "Spider 1",                      EntityType.SPIDER,            RaceType.SPIDER,          FormType.SPIDER_NORMAL,           ClassType.BEGGAR,         null,                                  Set.of(TeamType.SPIDER),                   180,               30,             1.5,               1.5f,             FightTrait.SPELLRATE_DEFAULT, FightTrait.SPEED_DEFAULT, FightTrait.SPEEDCOMBAT_DEFAULT, false),
	SPIDER_BIG(                    "spider_big",                    "Spider 6",                      EntityType.SPIDER,            RaceType.SPIDER,          FormType.SPIDER_BIG,              ClassType.BEGGAR,         Map.of(StatSecondary.SPELL_ARMOR, 2),     Set.of(TeamType.SPIDER),                   300,             25,            1.5,               2f,               5f,                           0.4f,                     1f,                             false),
	SPIDER_BOSS(                   "spider_boss",                   "Spider 5",                      EntityType.SPIDER,            RaceType.SPIDER,          FormType.SPIDER_BOSS,             ClassType.BEGGAR,         Map.of(StatSecondary.SPELL_ARMOR, 4),     Set.of(TeamType.SPIDER),                   600,             50,            3,                 2f,               15f,                          0.4f,                     1.2f,                           true),
	// pet                  
