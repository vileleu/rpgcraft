...
public enum TemplateType {
	...
	DEFAULT(                       "default",                       "Default",                       EntityType.SHULKER_BULLET,    RaceType.UNKNOWN,         FormType.UNKNOWN,                 ClassType.BEGGAR,         null,                                  null,                               0,                       5,             0,                  0f,               0f,                            1f,                       1.4f,                           false),
	// tauren
	...
	PALPOUTINE(                    "palpoutine",                    "Palpoutine",                    EntityType.PLAYER,            RaceType.HUMAN,           FormType.HUMAN_PALPOUTINE,        ClassType.PRIEST,         null,                                  Set.of(TeamType.BLACK),                    300,               30,            1.5,          	  1f,               10f,                          FightTrait.SPEED_DEFAULT, 1.3f,                           true),
	// desert                  
	...
	SCORPION(                      "scorpion",                      "Spider 7",                      EntityType.SPIDER,            RaceType.SCORPION,        FormType.SCORPION,                ClassType.BEGGAR,         null,                                  Set.of(TeamType.DESERT),                   180,               12,            0.5,                1.5f,             10f,                          0.8f,                     1.1f,                           false),
	// elemental                  
